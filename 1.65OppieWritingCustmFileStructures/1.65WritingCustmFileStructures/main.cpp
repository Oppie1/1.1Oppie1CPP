...
int main() {
	...
	//through storing the informaiton in the variables you created for the data. The arrows show flow. User "cin" >> to these variables.
...
//We do that by using the adamFile object. The arrows point where the data flow is. User iput goes to adamFile (adamFile<<User input)
