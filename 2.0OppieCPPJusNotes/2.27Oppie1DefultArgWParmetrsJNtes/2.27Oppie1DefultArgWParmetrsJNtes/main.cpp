...
//Create a function prototype and set the variables of length, width, height which will be defined after main to get voulume.
//CODE:
...
int main()
{
	...
	//Create a function call with ARGUMENTS that will show the volume out to the screen (l*w*h numbers)
	//CODE:
	cout << volume(3, 2, 4);
	...
	//Create a function call for volume without parameters.
	//CODE:
	cout << volume();
...
//Create a function definition from the prototype you created that returns (via an expression) the volume to the caller in main.
//CODE:
int volume(int l, int w, int h){

	//Again variables are like place holders for the actual data located in main.
	//return code AND expression are one an the same/happen at same time here. One line of code.
	//CODE:
	return l * w * h;
}
