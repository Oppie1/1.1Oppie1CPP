...
//CODE:
	...
	//So again if "x" in the function calls argument in main is any number other than 1 the code below will run.
	...
	//Create an else statement with an expression to return x times the factorialFinder function with the parameter x = 1
	//CODE:
