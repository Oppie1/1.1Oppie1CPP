...
//The Birthday dateOfBirthObj is an object parameter that retrives its information from the Birthday object created in main.
//Make a constructor declaration/declare a constructor People with parameters string name and Birthday dateOfBirthobj.
//CODE:
	...
	//Declare a void function prototype the will print that information to the screen.
	//CODE:
...
//Declare two variables one a string to store name and of type class (Birthday) variable (object) date of birth object. Member style.
//CODE:
